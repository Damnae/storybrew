...
namespace BrewLib.Graphics.Shaders
{
    ...
    {
        private int lastId;
        private string nextGenericName => $"_{variablePrefix}_{lastId++:000}";

        private string variablePrefix;
        private readonly List<ShaderVariable> variables = new List<ShaderVariable>();

        public ShaderPartScope(string variablePrefix)
        {

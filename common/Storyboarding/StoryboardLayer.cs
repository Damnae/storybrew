...
namespace StorybrewCommon.Storyboarding
{
    public abstract class StoryboardLayer : MarshalByRefObject
    {
        ...
        [Obsolete("OsbLayer comes from the storyboard layer and is ignored by this method")] public abstract OsbSprite CreateSprite(string path, OsbLayer layer = OsbLayer.Background, OsbOrigin origin = OsbOrigin.Centre);
    }
}

...
namespace StorybrewEditor.Graphics.Text
{
    public class FontManager : IDisposable
    {
        ...
        public Bitmap CreateBitmap(string text, string fontName, float fontSize, Vector2 maxSize, Vector2 padding, UiAlignment alignment, StringTrimming trimming, out Vector2 textureSize, bool measureOnly)
        {
            ...
            {
                case UiAlignment.Left: horizontalAlignment = StringAlignment.Near; break;
                case UiAlignment.Right: horizontalAlignment = StringAlignment.Far; break;
                default: horizontalAlignment = StringAlignment.Center; break;
            }

            StringAlignment verticalAlignment;
            switch (alignment & UiAlignment.Vertical)
            {
                case UiAlignment.Top: verticalAlignment = StringAlignment.Near; break;
                case UiAlignment.Bottom: verticalAlignment = StringAlignment.Far; break;
